...
public class DesignParkingSystem {
	ArrayList<Integer> bigCar;
	ArrayList<Integer> mediumCar;
	ArrayList<Integer> smallCar;

	public DesignParkingSystem(int big, int medium, int small) {
		bigCar = new ArrayList<>(big);
		mediumCar = new ArrayList<>(big);
		smallCar = new ArrayList<>(big);
	}

	public void addCar(int carType) {
		
		//if(carType == 1 && bigCar.i)
